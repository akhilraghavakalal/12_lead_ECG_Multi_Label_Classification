...
if __name__ == "__main__":
    main_source_directory = r"D:\Thesis_Project\Actual Physionet 2020 data\Four_Dataset_Sources"
    main_destination_directory = r"D:\Thesis_Project\12_lead_ECG_Classification\data\original_data"
